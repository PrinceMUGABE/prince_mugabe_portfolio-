...
export default function Resume() {
  ...
  script.onload = () => {
    ...
    const opt = {
      margin: 0.2, // Reduce margin further
    ...
    <div className="min-h-screen bg-gray-100 py-2">
      ...
      <div ref={resumeRef} className="max-w-4xl mx-auto bg-white p-6 shadow-lg print:shadow-none">
        ...
        <div className="border-b-2 border-blue-900 pb-2 mb-3">
          <h1 className="text-xs font-bold text-blue-900 mb-1">
            Prince MUGABE
          </h1>
        ...
        {/* Experience Section */}
        <div className="mb-1">
          <h2 className="text-xs font-bold pb-1 mb-1 text-blue-900 border-b border-gray-300">
            EXPERIENCE
          </h2>
          ...
          <div className="mb-3">
            ...
            <ul className="list-disc ml-4 space-y-0.5 text-xs text-gray-700 leading-snug">
              ...
              <li>Demonstrated strong multitasking abilities by simultaneously managing platform operations and customer service</li>
          ...
          <div className="mb-1">
            ...
            <ul className="list-disc ml-4 space-y-0.5 text-xs text-gray-700 leading-snug">
              ...
              {/* <li>Managed end-to-end inventory control and stock management for a manufacturing and distribution company, ensuring accurate records and optimal stock levels.</li>
              <li>Coordinated daily production, distribution, and sales operations to maintain supply chain efficiency and prevent disruptions.</li>
              <li>Oversaw human resources and team performance, assigning tasks and ensuring accountability for operational staff.</li>
              <li>Conducted situational analysis and prepared detailed operational reports with actionable recommendations for leadership.</li>
              <li>Supported logistics and distribution by operating company vehicles (cars and motorcycles) for emergency deliveries and operational recovery, ensuring timely fulfillment.</li> */}
            </ul>
          </div>
          ...
          <div className="mb-3">
            <div className="flex justify-between items-baseline mb-1">
              <h3 className="text-xs font-bold text-black">
                Software Developer Intern at Kaby Tech Solutions ltd
              </h3>
              <span className="text-xs font-semibold text-gray-700">
                Feb 2023 - Nov 2024
              </span>
          ...
          {/* <div className="mb-3">
            ...
            <ul className="list-disc ml-4 space-y-0.5 text-xs text-gray-700 leading-snug">
              <li className="">Conducted market research to identify potential sales opportunities and target markets</li>
              ...
              <li>Supported supply chain efficiency by conducting market research to forecast demand and identify potential sales opportunities, informing inventory planning.</li>
              <li>Analyzed market trends and competitor activities to provide strategic insights for stock levels and product portfolio decisions.</li>
              <li>Developed and executed sales plans, gaining direct experience in the link between sales targets and inventory requirements.</li>
            </ul>
          </div> */}
        ...
        {/* Education Section */}
        <div className="mb-1">
          <h2 className="text-xs font-bold text-blue-900 pb-1 mb-1 border-b border-gray-300">
            EDUCATION
          </h2>
          ...
          <div className="mb-1">
            <div className="flex justify-between items-baseline mb-0.5">
              <h3 className="text-xs font-bold text-black">
                Bachelor of Science in Information Technology (Software Engineering Department)
              </h3>
              <span className="text-xs font-semibold text-gray-700">
                2020 - 2024
              </span>
        ...
        <div className="mb-1">
          ...
          <div className="mb-1">
            ...
            <ul className="list-disc ml-4 space-y-0.5 text-xs text-gray-700 leading-snug">
              ...
              <li>Learned to navigate in different systems be it web applications and/or mobile applications</li>
            </ul>
          </div>
        ...
        <div className="mb-1">
          ...
          <div className="grid grid-cols-2 gap-x-4">
           ...
           {/* Languages and References Section - Flexed */}
        <div className="grid grid-cols-2 gap-4 mb-1">
          ...
          <div>
            ...
            {/* <ul className="list-disc ml-4 space-y-0.5 text-xs text-gray-700">
              <li>Thierry ISHIMWE: +250787875383 - Chief Executive Officer (CEO) of Big Tech Solutions Ltd (BTSL)</li>
              <li>Bahati HAKIZIMANA: +250780035234 - Developer at Urwego Finance</li>
              <li>Eustance MANIRAMBONA: +250783238452 - Production Manager at Crsytal Water Co Ltd</li>
            </ul> */}
          </div>
        </div>
      </div>
